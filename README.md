# GPTars v3.3.7 — macOS ARM TARS Voice Assistant 🤖

<p align="center">
  <img src="https://img.shields.io/badge/version-3.3.7-blue?style=for-the-badge" alt="Version" />
...
**NEW in v3.3.7**: Memory persistence, prime directives config, explicit setting commands ("set humor to 80").

**v3.3.6**: Audio cracking fix, conversation mode, and 20+ package upgrades.
...
<p align="center">
  <sub>GPTars v3.3.7 | December 2025 | macOS ARM</sub>
</p>
