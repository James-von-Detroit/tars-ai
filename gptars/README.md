# GPTars v3.0.1 — The macOS ARM TARS Voice Assistant 🤖
...
│   ├── M1-ALPHA-TEST-SETUP.md      │  Alpha test protocol
│   └── ARM-MAC-LOCAL-LLM-GUIDE.md  │  Local LLM deep dive
│
└── 🧪 tests/                       ← Test suite
\`\`\`
...
|-----------|---------|----------------|
| New code (voice, vision, installer) | MIT | ✅ Yes |
| TARS character/personality | CC-BY-NC 4.0 | ❌ No |
| Upstream TARS-AI code | CC-BY-NC 4.0 | ❌ No |
...
<p align="center">
  <sub>GPTars v3.0.1 | December 2024 | macOS ARM</sub>
</p>
